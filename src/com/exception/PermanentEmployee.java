...
public class PermanentEmployee implements Employee {
	...
	public PermanentEmployee(String id, String name, String department, String type, double salary, double hra,
	...
	public String toString() {
		return "PermanentEmployee [id=" + id + ", name=" + name + ", department=" + department + ", type=" + type
